...
interface GradeRepository {
    void save(GradeRecord record);

    Optional<GradeRecord> find(String studentId, String subjectId);

    List<GradeRecord> findByStudent(String studentId);
...
final class TextGradeFormatter implements GradeFormatter {
...
final class GradeService {
    ...
    private final ScoringStrategy scoring;
    private final GradingStrategy grading;
    private final GradeFormatter formatter;

    GradeService(GradeRepository repo,
                 ScoringStrategy scoring,
                 GradingStrategy grading,
                 GradeFormatter formatter) {
...
public class Main {
    public static void main(String[] args) {
        ...
        GradeRepository repo = new InMemoryGradeRepository();
        GradeFormatter fmt = new TextGradeFormatter(scoring, grading);

        GradeService svc = new GradeService(repo, scoring, grading, fmt);
